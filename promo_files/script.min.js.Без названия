...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(document.getElementById('demo-nouislider')) {
        ...
        let demoNoUiSlider = document.getElementById('demo-nouislider');
        let demoNoUiSliderStartInput = document.getElementById('demo-nouislider-start');
        let demoNoUiSliderEndInput = document.getElementById('demo-nouislider-end');
        
        var minval = Number($('#demo-nouislider-start').val());
        var maxval = Number($('#demo-nouislider-end').val());
  ...
  if(document.getElementById('demo-nouislider2')) {

        let demoNoUiSlider = document.getElementById('demo-nouislider2');
        let demoNoUiSliderStartInput = document.getElementById('demo-nouislider-start2');
        let demoNoUiSliderEndInput = document.getElementById('demo-nouislider-end2');
        
        var minval = Number($('#demo-nouislider-start2').val());
        var maxval = Number($('#demo-nouislider-end2').val());
  ...
  if(document.getElementById('demo-nouislider3')) {

        let demoNoUiSlider = document.getElementById('demo-nouislider3');
        let demoNoUiSliderStartInput = document.getElementById('demo-nouislider-start3');
        let demoNoUiSliderEndInput = document.getElementById('demo-nouislider-end3');
  ...
  if(document.getElementById('demo-nouislider4')) {

        let demoNoUiSlider = document.getElementById('demo-nouislider4');
        let demoNoUiSliderStartInput = document.getElementById('demo-nouislider-start4');
        let demoNoUiSliderEndInput = document.getElementById('demo-nouislider-end4');
...
$(document).ready(function(){
  $('.modal').on('show.nth.modal', function(){
    console.log('Модальное окно #modal-demo-01: сработало событие show.nth.modal');

    setTimeout(function() {

        var redline = $('.modal__close').offset().top
      $('.modal.modal--open').scroll(function(event) {
        var top = $(this).scrollTop();

        console.log(top)

        if (top > redline) {
          var offsetTopp = top-redline+3
          $('.modal__close').css({
            top:offsetTopp+'px'
          })
        }
